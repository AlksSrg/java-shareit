...
import ru.practicum.shareit.gateway.exception.booking.BookingNotFoundException;
import ru.practicum.shareit.gateway.exception.item.CommentNotAllowedException;
import ru.practicum.shareit.gateway.exception.item.ItemNotAvailableException;
import ru.practicum.shareit.gateway.exception.item.ItemNotFound;
import ru.practicum.shareit.gateway.exception.item.ItemNotOwnedByUserException;
import ru.practicum.shareit.gateway.exception.user.EmailAlreadyExistsException;
import ru.practicum.shareit.gateway.exception.user.UserNotFound;
